...
<html>
    ...
    <body>
        ...
        <h1><a href="/lab6">Лабораторная работа 6</a></h1>
        <h1><a href="/lab7">Лабораторная работа 7</a></h1>
        <h1><a href="/lab8">Лабораторная работа 8</a></h1>
        <h1><a href="/lab9">Лабораторная работа 9</a></h1>
